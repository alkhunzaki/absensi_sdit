...
<div class="max-w-2xl mx-auto py-12">
    <div class="text-center mb-10">
        ...
        <p class="text-lg text-gray-600">Silakan masukkan Nomor Induk Siswa (NIS) atau NISN untuk melihat laporan absensi dan akhlak anak Anda secara *real-time*.</p>
    </div>

    <div class="bg-white p-8 rounded-2xl shadow-xl border border-blue-50">
        <form action="info_siswa.php" method="GET" class="space-y-6">
            <div>
                <label for="nis" class="block text-sm font-semibold text-gray-700 mb-2">NIS atau NISN Siswa</label>
                <div class="relative">
                    ...
                    <input type="text" name="nis" id="nis" required
                        ...
                        placeholder="Contoh: 123456 atau 0012345678">
                </div>
            </div>
